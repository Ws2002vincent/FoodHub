...
public class VendorNavBar extends javax.swing.JPanel {
    ...
    public VendorNavBar(JFrame frame, String vendorID, String username, JPanel contentPanel, CardLayout cardLayout) {
        this.frame = frame;
    ...
    private void initComponents() {
        ...
        orderBtn.setText("Order History");
        ...
        notificationIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/foodhub/images/notificationIcon.png"))); // NOI18N
    ...
    private void revenueBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_revenueBtnActionPerformed
        cardLayout.show(contentPanel, "RevenueDashboard");
